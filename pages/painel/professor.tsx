      ...
      <ProtectedRoute allowedTypes={["professor"]}>
        ...
        <div className="p-8 pb-[25vh] flex flex-col items-center justify-center min-h-screen bg-gray-100">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 w-full max-w-2xl">
            <button
              className="bg-white text-gray-900 border border-gray-300 rounded-xl shadow-md p-8 text-xl font-semibold hover:bg-gray-900 hover:text-white transition focus:outline-none focus:ring-2 focus:ring-gray-700 focus:ring-offset-2 font-sans"
              onClick={() => {
                setViewMode('videos');
                setPlaylistSelecionada(null);
              }}
